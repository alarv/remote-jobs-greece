...
export default function JobListing({ job }: JobProps) {
  return (
    <a href={`/job/${job.id}`}>
      <div className="w-full px-4 py-4 sm:px-6 bg-white rounded-b-lg border-hidden dark:bg-gray-800 group hover:bg-indigo-50 hover:shadow-lg hover:border-indigo-500 ">
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center text-base font-semibold text-gray-900 dark:text-white">
                  {job.acf.salary_minimum_range && (
                    <p>{job.acf.salary_minimum_range.toLocaleString('en')}€</p>
                  )}
                </div>
              </div>
            </li>
