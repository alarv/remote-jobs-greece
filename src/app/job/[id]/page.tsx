    ...
    <main className="mx-auto max-w-7xl px-2 py-5 sm:px-6 lg:px-8 ">
      <div className=" mx-auto py-5 rounded-lg">
        ...
        <div className='col-span-2 container '>
          <div className='mx-4	'>
        <p className=" font-semibold mt-4">Company name: {job.acf.company_name}</p>
        <p className="font-semibold mt-4">Salary Range: {job.acf.salary_minimum_range}-{job.acf.salary_maximum_range}$
        </p>
        <p className="font-semibold">Employment type: {job.acf.employment_type}</p>
