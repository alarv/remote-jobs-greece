...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="mx-auto bg-indigo-600 ">
      <div className=" mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 p-5">
        <div>
        <div>
        <h1 className="text-3xl  text-white font-semibold ">{job.title.rendered}</h1>
        </div>
        <div>
        <Link
          href="/jobs"
        ...
        <div>
        <svg className="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
    <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M1 10c1.5 1.5 5.25 3 9 3s7.5-1.5 9-3m-9-1h.01M2 19h16a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1ZM14 5V3a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v2h8Z"/>
          ...
          <p className="font-semibold text-white">{job.acf.employment_type}</p>
        </div>
        <div>
    ...
    <path stroke="currentColor" stroke-linejoin="round" stroke-width="2" d="M10 6v4l3.276 3.276M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
      ...
      <div className="  py-5 px-2  sm:px-6 lg:px-8 bg-white">
